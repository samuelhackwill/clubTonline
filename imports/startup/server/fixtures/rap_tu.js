export const rap_tu = [    
    {
      type: "SB",
      text:
        "Salut c’est moi Samuel, je suis aussi ingénieur informaticien de ce guichet.",
    },
    {
      type: "SB",
      text:
...
{          
  type: "SB",
  text:
  "Admettons que tu viens de passer la pire journée de ta vie au travail.",
},
{          
  type: "SB",
  text:
  "tu as été dépassé.e par les évenements",
},
{          
  type: "SB",
  text:
  "Tout ce que tu déteste t'a été imposé,",
},
{          
  type: "SB",
  text:
  "tes vieux démons ont ressurgi.",
},
{          
  type: "---BB---",
...
},
{
  type: "SB",
  text:
    "Quand tu te sens prêt.e, tu peux aller à ta fenêtre, l'ouvrir, prendre une respiration, redresser tes épaules, et crier avec ta voix la plus grave ou la plus aigüe le nom de l'ennemi.",
},
{
  type: "SB",
  text:
    "Bon si tu veux rester assis.e tu peux aussi le faire sur place.",
},
{
  type: "---BB---",
  name:"play",
