export const lettre_tu = [    
    {
      type: "SB",
      text:
        "Bonjour ! Je suis Thomas, ton conseiller du club du travail pour aujourd’hui.",
    },
    {
      type: "SB",
      text:
        "Vers l’âge de 7 ans, j’ai écrit une lettre au roi de mon pays pour leur demander de transformer les semaines en des semaines de 2 jours en alternance : lundi-dimanche.",
    },
    {
      type: "SB",
      text:
    ...
    },
    {
      type: "---BB---",
      name: "qcm.lettre_roi",
      label: "Penses-tu que le roi ait lu ma lettre et ait réfléchi avec attention à ma proposition ?",
      qcmOptions: [
        "oui",
      ],
    },
    {
      ...
      label: "Penses-tu que pour ma revendication se fasse entendre, j’aurais dû :",
      qcmOptions: [
    ...
    },
    {
      type: "SB",
      text:
        "Quoi qu’il en soit, je suis heureux de t’aider dans tes propres revendications aujourd’hui."
    },
    {
      type: "---BB---",
    ...
    {          
      ...
      size: "s",
      label:
      "Comment résumerais-tu ton souhait?",
    },
    {
      type: "---BB---",
      save : true,
    ...
    {          
      ...
      size: "s",
      label:
      "Qu’est-ce qui te donnes envie dans cette vision ?",
    },
    {
      type: "SB",
      text:
      "Prends maintenant quelques secondes pour penser à quelque chose que tu ne souhaites plus jamais avoir dans ton environnement de travail, que tu veux mettre derrière toi."
    },
    {
      type: "SB",
      text:
    ...
    {          
      ...
      size: "s",
      label:
      "Donne un nom à cette chose/personne .",
    },
    {
      type: "SB",
      text:
      "Ce qu’on va faire maintenant c’est que tu vas pouvoir lui tourner le dos."
    },
    {
      type: "SB",
      text:
      "Dans quelques secondes tu vas pouvoir fermer les yeux, te retourner à 180° pour te retrouver dos à moi, et je vais l’incarner."
    },
    {
      type: "SB",
      text:
      "Tu vas pouvoir envoyer toutes tes énergies vers moi en imaginant qu’elles sortent de ton dos et je vais les absorber grâce à un super pouvoir informatique.",
    },
    {
      type: "SB",
      text:
      "Ça s’appelle « tourner le dos à ce qui fait écran ». Je vais m’occuper de tout balancer dans un vortex numérique. Si ça t’aide tu peux imaginer que des milliers de serveurs informatiques dispersés dans le monde entier vont découper ta chose en des milliers de petits morceaux.",
    },
    {
      type: "SB",
      text:
    ...
    {          
      ...
      size: "s",
      label:
      "Dans le fond, qui est ton/ta boss ? (ça peut être un pseudo)",
    },
    {          
      type: "---BB---",
      save : true,
